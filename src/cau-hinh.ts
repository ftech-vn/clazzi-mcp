...
export interface CauHinhThuongHieu {
   ...
   */
  daBiet: Record<string, { ten: string; laHeThat: boolean }>;
...
let HIEN_TAI: CauHinhThuongHieu | null = null;
...
export function quenCauHinh(): void {
  HIEN_TAI = null;
}
