...
import type { Crud, DanhMuc, Nhom, Tuyen } from './kieu.js';
import { TEN_NHOM } from './ten-nhom.js';
...
/** Quét toàn bộ kho `clazzi-api` thành danh mục. */
export function quetKho(gocClazziApi: string): DanhMuc {
